...
void Teavitus(BuildContext context, String contentMessage) {
  ...
  showDialog(
    ...
    builder: (BuildContext context) {
      return WillPopScope(
        ...
        onWillPop: () async {
          dialogDismissed =
              true; // Set the flag to true when the user dismisses the dialog
          return true;
        },
        child: Theme(
          ...
          child: AlertDialog(
            ...
            content: Card(
              color: Color.fromARGB(255, 230, 214, 129).withOpacity(0.95),
              shape: RoundedRectangleBorder(
                borderRadius: BorderRadius.circular(8.0),
                side: BorderSide(
                  color: Colors.black,
                ...
                child: Row(
                  ...
                  children: [
                    Icon(
                      Icons.message_sharp,
                      size: 60.0,
                      color: Color.fromARGB(255, 144, 169, 238),
                    ),
                    SizedBox(width: 16.0),
                    Expanded(
                      child: Column(
